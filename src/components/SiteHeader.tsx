  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/35 bg-[#f3f8f3]/55 backdrop-blur-xl">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="hidden items-center gap-7 text-sm font-extrabold uppercase tracking-[0.2em] text-[#27382b] md:flex">
          {navItems.map((item) => (
        ...
        <button
          ...
          className="btn-3d btn-secondary grid size-10 place-items-center md:hidden"
        >
      ...
      {isOpen ? (
        <div className="border-t border-emerald-950/10 bg-[#f3f8f3]/95 px-5 py-4 shadow-[0_18px_40px_rgba(40,55,35,0.14)] md:hidden">
